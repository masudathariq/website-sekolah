...
<div class="max-w-3xl mx-auto p-6 bg-white rounded shadow">
    <h1 class="text-2xl font-bold mb-6">Edit Kalender Akademik</h1>

    <form action="{{ route('admin.kalender_akademik.update', $kalender_akademik->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="judul"
                id="judul"
                value="{{ old('judul', $kalender_akademik->judul) }}"
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="tanggal"
                id="tanggal"
                value="{{ old('tanggal', $kalender_akademik->tanggal->format('Y-m-d')) }}"
        ...
        <div class="mb-4">
            ...
            <textarea
                ...
                required
            >{{ old('deskripsi', $kalender_akademik->deskripsi) }}</textarea>
            @error('deskripsi')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
